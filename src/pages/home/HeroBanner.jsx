...
const HeroBanner = () => {
  ...
  const heroData = Array.isArray(rawData)
    ? rawData[0]
  ...
  const imageSrc =
    ...
    (heroData.avatarUrl &&
      heroData.avatarUrl.trim() !== "" &&
      heroData.avatarUrl) ||
    (heroData.heroImage &&
      heroData.heroImage.trim() !== "" &&
      heroData.heroImage) ||
    DEFAULT_AVATAR;
  ...
  const primaryLink = heroData.primaryBtnLink || "/projects";
        ...
        <div className="hero-left-content">
          ...
          <div className="hero-top-row">
            ...
            <div className="social-icons-wrapper">
              {Array.isArray(heroData.socials) &&
              heroData.socials.length > 0 ? (
          ...
          <div className="hero-action-buttons">
            ...
            {secondaryText && (
              <Link to="/resume" className="btn-cyan-download">
          ...
          <div className="hero-scroll-indicator">
            <span className="scroll-text">
              {heroData.scrollText || "Scroll Down"}
            </span>
            <a
              href="#projects-section"
              className="scroll-arrow-circle"
