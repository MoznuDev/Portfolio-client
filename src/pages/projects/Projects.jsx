...
import { FaExternalLinkAlt, FaGithub, FaFolder, FaStar, FaChevronDown, FaChevronUp } from 'react-icons/fa';
...
const Projects = () => {
  ...
  const categoryFiltered = activeCategory === 'All Projects'
    ? projectsList
    : projectsList.filter((project) => project.category === activeCategory);

  // showAll true হলে সব দেখাবে, নাহলে প্রথম ৬টি দেখাবে
  const filteredProjects = showAll ? categoryFiltered : categoryFiltered.slice(0, 6);
    ...
    <section className="projects-section" id="projects">
      <div className="projects-container">
        ...
        {filteredProjects.length === 0 ? (
          <div className="no-projects-found" style={{ textAlign: 'center', padding: '3rem 0', color: '#9ca3af' }}>
                    ...
                    <div className="project-folder-wrapper">
                      ...
                      <div className="project-image-container relative cursor-pointer">
                        ...
                        <div className="project-overlay" onClick={(e) => e.stopPropagation()}>
                          {githubClient && (
                            <a href={githubClient} target="_blank" rel="noopener noreferrer" title="GitHub Client Code">
                              <FaGithub />
                            </a>
                          )}
                          {githubServer && (
                            <a href={githubServer} target="_blank" rel="noopener noreferrer" title="GitHub Server Code">
